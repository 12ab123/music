            ...
            <div class="songListInfo">
                ...
                <div class="right">
                    ...
                    <div class="authorInfo">
                        <img :src="songListInfo.authorImg" alt="">
                        <div class="authorName">{{songListInfo.authorName}}</div>
                    </div>
...
<script>
    import { reqSongListInfo, reqSongInfo } from '@/api'
    ...
    export default {
        ...
        methods: {
            async getSongListInfo () {
                let result = await reqSongListInfo(this.$route.params.id)
                let songListInfo = {
                    backImg: result.playlist.coverImgUrl,
                    authorImg: result.playlist.creator.avatarUrl,
                    name: result.playlist.name,
                    description: result.playlist.description,
                    authorName: result.playlist.creator.nickname,
                    tags: result.playlist.tags,
                }
                this.songListInfo = songListInfo
                this.songListId = result.playlist.trackIds.map((item,index)=>item.id)
